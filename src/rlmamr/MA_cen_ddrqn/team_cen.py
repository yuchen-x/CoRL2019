...
from .envs_runner_cen import EnvsRunner
from .model_cen import DDRQN
...
class Team_RNN(Team):
    ...
    def train(self):
        ...
        self.training_method(self.cen_controller, batch, self.hysteretic, self.discount, **self.hyper_params)
